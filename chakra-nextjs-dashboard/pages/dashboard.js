        ...
        >
            ...
            >
                ...
                <Flex
                    ...
                    gap={4} 
                >     
                    <RealTimeGraph data = {hydro_watts} labels={times} label="Watts" w="50%" h="40vh" m="3" title="Power Produced by Hydro" backgroundColor="#4299e1" borderColor="#3182ce"/>
                    <RealTimeGraph data = {0} labels={times} label = "Watts" w="50%" h="40vh" m="3" title="Power Generated by Wind" backgroundColor="#B2F5EA" borderColor="#81E6D9"/>
                </Flex>
                <Flex
                    flexDir="row"       
                    align="center"      
                    gap={4} 
                > 
                    <RealTimeGraph data = {solar_watts} labels={times} label="Watts" w="50%" h="35vh" m="3" title="Power Generated by Solar" backgroundColor="#ECC94B" borderColor="#D69E2E"/>
