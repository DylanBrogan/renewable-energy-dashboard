        ...
        >
            ...
            >
                ...
                <Flex
                    ...
                    gap={4} 
                >     
                    <MyChart data = {watts} labels={times} w="50%" h="40vh" m="3" title="Power Produced by Solar Panel"/>
                    <MyChart data = {watts} labels={times} w="50%" h="40vh" m="3" title="Power Generated by System"/>
                </Flex>
                <Flex
                    flexDir="row"       
                    align="center"      
                    gap={4} 
                >     
                    <MyChart data = {surfaceTemperature} labels={times} w="100%" h="35vh" m="3" title="Temperature of Solar Panel"/>
                </Flex>
            </Flex>
